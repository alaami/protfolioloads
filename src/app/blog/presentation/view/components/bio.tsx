    ...
    <StyledPaper elevation={0}>
      <Grid container spacing={2} marginBottom={5}>
        <Grid item xs={12} md={6} lg={6} xl={6}  >
          <Paper sx={{ borderTopRightRadius:20, borderBottomRightRadius:20, padding:5,  borpadding: 5, marginBottom: 15, marginTop: 5, fontSize: 20, color: theme.palette.primary.contrastText, backgroundColor: theme.palette.primary.main }} elevation={0}>
            <Stack>
              <Box >
